  ...
  return (
    <>
      ...
      <p className="text-justify">
        ...
        uma ferramenta eficiente e amigável para a montagem de horários,
        otimizando assim a gestão do tempo dos alunos.
      </p>
    </>
  );
}
  ...
  return (
    <>
      ...
      <p className="pb-5 text-justify">
        Na página inicial, clique no botão <b>Buscar Matéria</b> para selecionar
        as disciplinas desejadas para a sua grade. Escolha o ano/período e
        insira o nome da disciplina para poder optar por turmas potenciais na
        criação da grade, permitindo a escolha de até quatro turmas para cada
        disciplina.
      </p>
      <p className="pb-5 text-justify">
        Após fazer suas escolhas, clique no botão <b>Gerar Grade</b> e defina a
        prioridade dos turnos que melhor se adequam à sua rotina. Em seguida,
        basta escolher a grade mais adequada entre as opções geradas para
        realizar o download e/ou salvar as disciplinas escolhidas.
      </p>
      <p className="text-justify">
        Compartilhe suas experiências e sugestões. O aplicativo está em
        constante desenvolvimento, e seu feedback é valioso para aprimorar a
...
function HowToContribute() {
  return (
    <>
      ...
      <p className="text-justify">
        Se você é um programador e deseja contribuir com nosso projeto, basta{' '}
        <a
          href="https://unb-mds.github.io/2023-2-SuaGradeUnB/contributing/"
          target="_blank"
          className="text-primary hover:underline"
        >
          clicar aqui
        </a>{' '}
        para ter acesso a nossa documentação. Lá você encontrará todos os
        detalhes de como contribuir com novas funcionalidades e reportar
        possíveis erros.
      </p>
    </>
  );
